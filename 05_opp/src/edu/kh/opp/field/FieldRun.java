package edu.kh.opp.field;

import edu.kh.opp.field.model.vo.Student;
import edu.kh.opp.field.model.vo.Trainee;
...
//		std2.schoolName ="KH대학 부속 고등학교";
		...
		System.out.println(t1.email);// 초기화가 되어있는가?
		System.out.println(t1.salary);// 초기화가 되어있는가?
		System.out.println(t1.classRoom);// 초기화가 되어있는가?

		Trainee t2 = new Trainee(); //훈련생 객체 생성
		
		System.out.println(t2.name);
		System.out.println(t2.phone);
		System.out.println(t2.email);// 초기화가 되어있는가?
		System.out.println(t2.salary);// 초기화가 되어있는가?
		System.out.println(t2.classRoom);// 초기화가 되어있는가?
