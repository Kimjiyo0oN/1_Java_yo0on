package edu.kh.opp.constructor.model.vo;

public class Member {
	 	//추상화 ->  아이디, 비빌번호, 전화번호, 나이
...
//		}
		...
		//타입의 순서가 달라지면 인식이 됨
//		public Member(String memberPw, int memberAge,String memberId, String memberPhone) {
//			
//		}
