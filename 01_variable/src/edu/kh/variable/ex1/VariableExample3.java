...
public class VariableExample3 {
	...
	public static void main(String[] args) {
		...
		int abcdefg;
		int showMeTheMoney;
		int dfkladskfdkflaklsfk; // 길이 제한 X // 띄어쓰기하면 에러
		...
		System.out.println(age +10); // 숫자 + 숫자 = 숫자합
		...
		System.out.println(name + "님은 " + age + "세 "+ myGender + "성입니다.");
		
		System.out.printf("%s님은 %d세 %s입니다.\n", name, age, gender);
		...
		num3 = num3 + DOWN * 3; //( DOWN + DOWN + DOWN ) , 사칙연산 우선순위(*,/ 먼저)
